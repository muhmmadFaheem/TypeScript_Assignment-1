...
let mesg = famous_person + "once said Dont confuse schooling with education.I didnt go to Harvard but the people that work for me did.";
console.log(mesg);
let name3 = "\t\n Faheem\t\n";
console.log(name3);
...
//Question 11..
let names = ["Babar", "Rizwan", "Saim"];
for (let i = 0; i < names.length; i++) {
    console.log(names[i]);
}
//Question 12..
let names1 = ["Junaid", "Jamal", "Jamshed"];
